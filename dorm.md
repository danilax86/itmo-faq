...
- ГК - 1 час
- Ломо - 40 минут
- Метро: Проспект Славы, 15 минут пешком

### Цена за месяц
 900 рублей. За 15 этаж и комнаты без балкона чуть поменьше.

### Плюсы
+ В большинстве комнатах есть ремонт
+ Комнаты по 2 человека
+ Везде - блоки по 6 комнат
+ Пропускают 24/7
...
- На нескольких этажах все еще нет ремонта
- Тараканы местами есть
- Душ на первом и/или втором этаже, нельзя сходить в душ после часа ночи
- Курение, распитие и хранение алкоголя запрещены(как собственно и везде)
...
Некоторые моменты, которые не "плюсы" и не "минусы". В других отзывах пишут про "кулинаров", на Альпийке вроде таких нет. К коменде нужно найти подход. В комнатах стоят динамики пожарной сигнализации, которые нельзя выключать или накрывать. Проблема в том, что они СЛИШКОМ громкие и имеют свойства срабатывать примерно раз в три месяца.
...
- Тараканов нет, если появляются, то можно сказать коменде и их будут травить, либо Вы делаете это сами.
- Рядом огромная круглосуточная лента.
- Есть игровая(для настолок, также там есть пианино) на 9 этаже, 3 учебные комнаты, 5 спортивных залов.
